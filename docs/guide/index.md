...
Instead of visiting seven different websites to find a paper, MOSAIC queries them all at once, deduplicates the results by DOI, and — when a PDF is available — downloads it to your local disk.
