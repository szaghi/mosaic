...
features:
  - icon: 🔍
    ...
    details: Query arXiv, Semantic Scholar, ScienceDirect, DOAJ, Europe PMC, OpenAlex, BASE, and CORE simultaneously. Results are deduplicated by DOI so you never see the same paper twice.
  - icon: 📄
    title: PDF Download
...
flowchart LR
    ...
    Search --> SD[ScienceDirect]
    Search --> DOAJ
    Search --> EPMC[Europe PMC]
    arXiv & SS & SD & DOAJ & EPMC -->|Paper list| Dedup
