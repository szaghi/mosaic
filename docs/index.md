...
features:
  - icon: 🔍
    ...
    details: Query arXiv, Semantic Scholar, ScienceDirect, Springer Nature (browser + API), DOAJ, Europe PMC, OpenAlex, BASE, CORE, NASA ADS, IEEE Xplore, Zenodo, and Crossref simultaneously. Results are deduplicated by DOI so you never see the same paper twice.
  - icon: 📄
    title: PDF Download
...
flowchart LR
    ...
    arXiv & SS & SD & SP & SPN & DOAJ & EPMC & OA & BASE & CORE & ADS & IEEE & ZEN & CR -->|Paper list| Dedup
